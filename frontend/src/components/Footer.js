          ...
          <div className="row">
            ...
            <div className="col-lg-6 col-md-6 mb-4">
              <div className="footer-section">
                <h5 className="footer-title fw-bold" style={{ color: '#ffffff' }}>
                  OffSole
                </h5>
                ...
                <div className="contact-info" style={{ color: '#cccccc', marginTop: '15px' }}>
                  <p>
                    <i className="fas fa-map-marker-alt" style={{ marginRight: '8px' }}></i> Shop
                    No. 15, Nikol Market, Nikol, Ahmedabad - 382350, Gujarat, India
                  </p>
                  <p>
                    <i className="fas fa-phone" style={{ marginRight: '8px' }}></i> +91-98765-43210
                  </p>
                  <p>
              ...
              <div className="footer-section">
                <div className="row">
                  ...
                  <div className="col-md-6">
                    <h6 className="footer-subtitle" style={{ color: '#ffffff' }}>
                      Quick Links
                    </h6>
                    <ul className="footer-links">
                      ...
                      <li>
                        <Link to="/products" style={{ color: '#cccccc' }}>
                          Products
                        </Link>
                      </li>
                      <li>
                        <Link to="/about" style={{ color: '#cccccc' }}>
                          About Us
                        </Link>
                      </li>
                      <li>
                        <Link to="/contact" style={{ color: '#cccccc' }}>
                          Contact
                        </Link>
                      </li>
                    </ul>
        ...
        <div className="footer-bottom">
          <div className="row align-items-center">
            <div className="col-12 text-center">
              <p className="copyright" style={{ color: '#999999' }}>
                &copy; 2026 OffSole. All rights reserved. | Nikol, Ahmedabad, Gujarat, India
              </p>
            </div>
          </div>
        </div>
