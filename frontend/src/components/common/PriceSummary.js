...
const PriceSummary = ({ subtotal, shipping, gst, total, showCheckoutBtn = false, onCheckout, btnText = 'Proceed to Checkout' }) => {
  return (
      ...
      <div className="card-body p-4">
        ...
        <div className="d-flex justify-content-between mb-2">
          <span className="text-muted">
            Estimated Delivery
            {shipping === 0 && <span className="badge bg-success-subtle text-success ms-2">FREE</span>}
          </span>
        ...
        {subtotal > 0 && subtotal < 1000 && (
          <div className="alert alert-info py-2 px-3 small mb-3">
            Add <strong>{formatCurrency(1000 - subtotal)}</strong> more for <strong>FREE Delivery</strong>!
          </div>
        )}
